...
class CreateUserService {
    ...
    constructor(
        ...
        // cria objeto usersRepository: no formato IUsersRepository
        // e instancia é criada a partir do inject 'UsersRepository'
        // comando diferenciado de new
    ...
    public async execute({ name, email, password }: IRequest): Promise<User> {
        ...
        // verifica se o email existe a partir de index container
        // UserRepository ->aqui vem a resposta
        ...
        // após que criar a lista devemos invalidar o cache anteriormente salvo.
